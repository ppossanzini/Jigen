...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    PagePlaceholder: typeof import('./../components/common/page-placeholder.vue')['default']
...
declare global {
  ...
  const PagePlaceholder: typeof import('./../components/common/page-placeholder.vue')['default']
