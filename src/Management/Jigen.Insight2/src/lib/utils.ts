 ...
 * Accepts `string` too since the server's generated numeric types are
 * `number | string` (its OpenAPI schema encodes int64/int32 that way).
 */
...
/** Formats a `number | string` value with locale thousand separators, or `—` if absent. */
