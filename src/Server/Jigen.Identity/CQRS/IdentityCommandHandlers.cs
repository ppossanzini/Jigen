...
public class IdentityCommandHandlers(
  ...
  IRequestHandler<Core.Command.identity.Login, IdentityCommandResult>,
  IRequestHandler<Core.Command.identity.Logout>,
  IRequestHandler<Core.Command.identity.CreateClient, CreateClientResult>,
  IRequestHandler<Core.Command.identity.ExchangeToken, ExchangeTokenResult>,
  IRequestHandler<Core.Command.identity.CreateUser, IdentityCommandResult>,
  IRequestHandler<Core.Command.identity.UpdateUser, IdentityCommandResult>,
  IRequestHandler<Core.Command.identity.DeleteUser, IdentityCommandResult>,
  IRequestHandler<Core.Command.identity.CreateRole, IdentityCommandResult>,
  IRequestHandler<Core.Command.identity.UpdateRole, IdentityCommandResult>,
  IRequestHandler<Core.Command.identity.DeleteRole, IdentityCommandResult>
{
  public async Task<IdentityCommandResult> Handle(Core.Command.identity.Login request, CancellationToken cancellationToken)
  {
  ...
  public Task Handle(Core.Command.identity.Logout request, CancellationToken cancellationToken)
  {
    return signInManager.SignOutAsync();
  }

  public async Task<CreateClientResult> Handle(Core.Command.identity.CreateClient request, CancellationToken cancellationToken)
  {
    if (request?.Data == null)
    {
  ...
  public Task<ExchangeTokenResult> Handle(Core.Command.identity.ExchangeToken request, CancellationToken cancellationToken)
  {
    if (request?.Data == null)
    {
  ...
  public async Task<IdentityCommandResult> Handle(Core.Command.identity.CreateUser request, CancellationToken cancellationToken)
  {
    if (request?.Data == null ||
        string.IsNullOrWhiteSpace(request.Data.UserName) ||
        string.IsNullOrWhiteSpace(request.Data.Password))
  ...
  public async Task<IdentityCommandResult> Handle(Core.Command.identity.UpdateUser request, CancellationToken cancellationToken)
  {
  ...
  public async Task<IdentityCommandResult> Handle(Core.Command.identity.DeleteUser request, CancellationToken cancellationToken)
  {
  ...
  public async Task<IdentityCommandResult> Handle(Core.Command.identity.CreateRole request, CancellationToken cancellationToken)
  {
  ...
  public async Task<IdentityCommandResult> Handle(Core.Command.identity.UpdateRole request, CancellationToken cancellationToken)
  {
  ...
  public async Task<IdentityCommandResult> Handle(Core.Command.identity.DeleteRole request, CancellationToken cancellationToken)
  {
    if (string.IsNullOrWhiteSpace(request?.Id))
    {
      return new IdentityCommandResult
