...
var hits = products.Search(
  ...
  top: 5);`;
export default function ServerPage(){return <DetailShell eyebrow="SERVER TOPOLOGY" index="03 / 05" title="One vector service. Multiple clients and workers." intro="The server turns the embedded engine into a shared platform: multi-database hosting, gRPC and REST APIs, typed .NET access, identity modules and independently scalable embedding generation.">
